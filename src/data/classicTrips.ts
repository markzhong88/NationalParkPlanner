...
export const CLASSIC_TRIPS: ClassicTrip[] = [
  ...
  {
    slug: "yellowstone-grand-teton-7-day",
    title: "7-day Yellowstone and Grand Teton road trip",
    description:
      "A 7-day two-park loop from Bozeman: Old Faithful and Grand Prismatic, then Jenny Lake in the Tetons. Overnight towns, a 2.5-hour hop between the parks, and a map.",
    parkId: "yellowstone",
    alsoParkId: "grand-teton",
    home: "Bozeman, MT",
    days: 7,
    adults: 2,
    kids: 2,
    covers: ["jenny", "prismatic"],
  },
  {
    slug: "yosemite-sequoia-7-day",
    title: "7-day Yosemite and Sequoia road trip",
    description:
      "A 7-day Sierra loop from San Francisco: Yosemite Valley, then Giant Forest and General Sherman. Two parks, one drive, overnight towns and a map.",
    parkId: "yosemite",
    alsoParkId: "sequoia",
    home: "San Francisco, CA",
    days: 7,
    adults: 2,
    kids: 2,
    covers: ["half-dome", "sherman"],
  },
  {
    slug: "olympic-mount-rainier-7-day",
    title: "7-day Olympic and Mount Rainier road trip",
    description:
      "A 7-day Washington loop from Seattle: Hurricane Ridge and the rainforest, then Paradise at Rainier. Two parks that share a real drive.",
    parkId: "olympic",
    alsoParkId: "mount-rainier",
    home: "Seattle, WA",
    days: 7,
    adults: 2,
    kids: 2,
    covers: ["hurricane", "paradise"],
  },
  {
    slug: "arches-capitol-reef-6-day",
    title: "6-day Arches and Capitol Reef road trip",
    description:
      "A 6-day Utah loop from Grand Junction: Delicate Arch and Moab, then Fruita and the Waterpocket Fold. Two Mighty 5 parks on one drive.",
    parkId: "arches",
    alsoParkId: "capitol-reef",
    home: "Grand Junction, CO",
    days: 6,
    adults: 2,
    kids: 2,
    covers: ["delicate", "fruita"],
  },
  {
    slug: "joshua-tree-death-valley-6-day",
    title: "6-day Joshua Tree and Death Valley road trip",
    description:
      "A 6-day desert loop from Las Vegas: Jumbo Rocks and Joshua Tree, then Badwater Basin. Two parks, a 3.5-hour drive, overnight towns and a map.",
    parkId: "joshua-tree",
    alsoParkId: "death-valley",
    home: "Las Vegas, NV",
    days: 6,
    adults: 2,
    kids: 2,
    covers: ["jumbo", "badwater"],
  },
  {
    slug: "bryce-zion-6-day",
    title: "6-day Bryce Canyon and Zion road trip",
    description:
      "A 6-day Southern Utah loop from Las Vegas: the Bryce Amphitheater, then Zion Canyon. Two parks about two hours apart.",
    parkId: "bryce-canyon",
    alsoParkId: "zion",
    home: "Las Vegas, NV",
    days: 6,
    adults: 2,
    kids: 2,
    covers: ["amphitheater", "zion-narrows"],
  },
];
